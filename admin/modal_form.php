        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
                    ...
                    <h5><center>Penerbit: <strong><?php echo $deleteData['penerbit']; ?></strong></center></h5> 
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                    <a href="../admin/proses_delete_buku.php?id=<?php echo $data['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
                ...
                <form method="POST" action="proses_edit_buku.php?id=<?php echo $editData['id']; ?>">
                    ...
                    <div class="modal-body">       
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control" value="<?php echo $editData['judul']; ?>" readonly>
                        </div>               
                        <div class="form-group">
