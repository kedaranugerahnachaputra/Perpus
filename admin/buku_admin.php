...
<table class="table table-striped table-hover table-sm table-bordered">
    ...
    if(mysqli_num_rows($sql) > 0){
      ...
      while($data = mysqli_fetch_array($sql)){
        ...
        <tr>
          ...
          <td>
            <a href="#edit<?php echo $data['id']; ?>" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-edit"></span> Edit</a>
  ...
  <tbody>
    ...
    <div>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" data-title="tambahBuku"><b>Tambah Data</b></button>
    </div>
